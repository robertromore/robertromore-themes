...
cleo boasts a clean HTML5 structure with extensible CSS classes and IDs for
...
cleo's goal is to provide themers the building blocks needed to get their
designs up and running quickly and simply.

cleo is perfect if you want a simple, smart, and flexible theme starter.
...
cleo utilizes SASS for adaptive grids and layouts and general structure of the
...
cleo is meant to be YOUR theme. Follow one of the two methods below and you can
rename 'cleo' to another name like 'mytheme'. You're also welcome to keep
'cleo'.

1. DRUSH: The provided drush install script will duplicate the cleo theme
   folder and rename all appropriate files and content to the new theme name you
   provide.

  - Download and install the cleo theme: $ drush en cleo
  - Run the provided drush install script: $ drush cleo-install
  ...
  - At this time, you can uninstall cleo: $drush pmu cleo
...
2. MANUAL: To manually change the name of the theme follow these steps BEFORE
  ...
  - Rename cleo.info.yml to mytheme.info.yml
  - edit cleo.info.yml and change the name, description, project (can be
    deleted), and change all other instances of 'cleo' to 'mytheme'
  - Rename cleo.libraries.yml to mytheme.libraries.yml
  - Rename cleo.theme to mytheme.theme
  - in cleo.theme, change each instance of 'cleo' to 'mytheme'
  - Rename config/schema/cleo.schema.yml to mytheme.schema.yml
  - Rename each file in config/install from block.block.cleo_tools.yml (for
    example) to block.block.mytheme_tools.yml
  - Every file in config/install, change each instance of 'cleo' to
    'mytheme'
  - In js/source/scripts.js, change each instance of 'cleo' to 'mytheme'
  - In theme-settings.php, change each instance of 'cleo' to 'mytheme'
  - In templates/html.html.twig, change each instance of 'cleo' to 'mytheme'
  - In templates/menu-local-tasks.html.twig, change each instance of 'cleo' to
    'mytheme'
  - In templates/status-messages.html.twig, change each instance of 'cleo' to
    'mytheme'

  When renaming, remember the following:
  - Do not simply replace every instance of 'cleo' in every file in the theme.
    Most of cleo's dependencies use the word 'cleo' somewhere and renaming
    these instances will cause cleo to break in unpredictable ways.
  ...
  - If you don't bother renaming cleo in the above locations, be advised that
    you will run into conflicts with other versions of cleo on your site. If
    your site uses more than one theme based on cleo, make sure at least one of
    the themes has been renamed properly!


============================
How to compile SASS in cleo
============================

To use SASS and automatically compile it within your theme, please refer to "How
to Use Grunt with cleo" in the documentation below.
...
- build/scripts.js & source/scripts.js
  ...
  folder. See comments in cleo.libraries.yml file to enable the starter
  scripts.js file.
...
The layout used in cleo is fairly similar to the Holy Grail method. It has been
...
This is how the page template is buit in cleo, and it works in fluid and fixed
layout. Refer to the notes in layout.sass to see how to modify the layout.


===========================
How to Use Grunt with cleo
===========================
...
Once Node.JS is installed, go to the root folder of cleo and install your Grunt
packages:
...
Once installed, cd to the root folder of cleo and run Grunt via the command
line:
...
Once you start using cleo, you will massively change it until you reach the
point where it has nothing to do with cleo anymore. Unlike Zen, cleo is not
...
version of cleo comes out. Always see cleo as a STARTER, and as soon as you
start using it, it is not cleo anymore, but your own theme.

If you didn't rename your theme, but you don't want to be notified when cleo
has a new version by the update module, simply delete "project = "cleo" in
cleo.info.yml.
...
Thanks for using cleo, and remember to use the issue queue in drupal.org for
any questions or bug reports:

http://drupal.org/project/issues/cleo
